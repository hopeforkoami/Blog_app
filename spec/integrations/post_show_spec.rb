...
RSpec.describe 'PostIndex', type: :feature do
  describe 'post show page' do
    before(:each) do
      @author = User.create(name: 'Koami NOGBEDJI', photo: 'https://linktomyphoto.com/koami_profil',
                            bio: 'developper and author')
      @user1 = User.create(name: 'Enoque Macanda', photo: 'https://linktomyphoto.com/enoque_profil',
      ...
      @post = Post.create(title: 'post job', text: 'Job Searching
        ...
        rutrum dictum diam euismod sit amet. Maecenas vitae urna metus. Fusce tempor facilisis scelerisque.
         Vivamus fermentum,
